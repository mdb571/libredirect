...
chrome.runtime.onInstalled.addListener(() => {
  ...
  async function wholeInit() {
    youtubeHelper.init(browser)
    youtubeMusicHelper.init(browser)
    twitterHelper.init(browser)
    instagramHelper.init(browser)
    mapsHelper.init(browser)
    searchHelper.init(browser)
    translateHelper.init(browser)
    mediumHelper.init(browser)
    redditHelper.init(browser)
    wikipediaHelper.init(browser)
    imgurHelper.init(browser)
    tiktokHelper.init(browser)
    generalHelper.init(browser)
  }
  wholeInit();
